...
public class AddStudent extends JFrame {
	 ...
	 */
	public AddStudent() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AddStudent.class.getResource("/images/logo.png")));
		...
		JLabel lblQuestionBank = new JLabel("Add Student");
		...
		JButton btnViewAllStudents = new JButton("View All Student Details");
		btnViewAllStudents.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0)
			{
				
				dispose();
				ViewAllStudents frameObj=new ViewAllStudents();
				frameObj.setVisible(true);	
			}
		});
		btnViewAllStudents.setFont(new Font("Arial", Font.PLAIN, 18));
		btnViewAllStudents.setBounds(304, 13, 263, 49);
		panel_4.add(btnViewAllStudents);
		...
		JLabel label_5 = new JLabel("Mother's Name");
		label_5.setHorizontalAlignment(SwingConstants.TRAILING);
		label_5.setFont(new Font("Arial", Font.PLAIN, 20));
		label_5.setBounds(86, 142, 133, 39);
		panel_5.add(label_5);
		...
		spinnerYear.setModel(new SpinnerNumberModel(2000, 1970, 2005, 1));
		...
		comboBoxCourse.setModel(new DefaultComboBoxModel(new String[] {"MCA", "BTech CSE", "BTech IT", "BCA"}));
		...
		label_20.setIcon(new ImageIcon(AddStudent.class.getResource("/images/b10.jpg")));
	...
	JTextArea textAreaAddr;
		...
		boolean val=false;
		val=Validation.ValidationStudent(Name,FName, MName, Email, Mob, Pass, Date, Month, Year, Gender, Course, Addr);
		
		if(val)
		{
			try 
			{
				String query = "INSERT INTO studentlogin (s_name,s_Fname,s_Mname,s_Email,s_Password,s_Phone,s_DOB_D,s_DOB_M,s_DOB_Y,s_Addr,s_G,S_Course) " +
						"Values ('"+Name+"'," +
								"'"+FName+"'," +
								"'"+MName+"'," +
								"'"+Email+"'," +
